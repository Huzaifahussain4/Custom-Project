  ...
  const fetchData = async () => {
    try {
      ...
      const response = await fetch(
        "http://127.0.0.1:8000/api/Product_New_Listed/"
      );
    ...
    <div className="dashboard-container">
      ...
      <div className="table-container">
        ...
        <div className="table-header">
          ...
          <div className="col-1 text-left">3-days Units Sold</div>
          <div className="col-1 text-left">3-days GMV</div>
          ...
          <div key={index} className="table-row">
            ...
            <div className="col-2 flex-align-start">
              ...
              <div className="product-info">
                ...
                <div className="col-1">{row["Country/Region"] || "N/A"}</div>
                <div className="col-1">{row["Categories"] || "N/A"}</div>
              </div>
            </div>
            ...
            <div className="col-1">
              ...
              {/* <div className="shop-units">Units Sold: {row['Total Units Sold'] || '0'}</div> */}
            </div>
            ...
            {/* 3-days Units Sold */}
            <div className="col-1 text-left">
              {row["3-days Units Sold"] || "0"}
            </div>

            {/* 3-days GMV */}
            <div className="col-1 text-left">{row["3-days GMV"] || "$0"}</div>
