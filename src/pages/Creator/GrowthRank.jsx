  ...
  const fetchData = async () => {
    try {
      ...
      const response = await fetch(
        "http://127.0.0.1:8000/api/Creator_Growth_Rank/"
      );
    ...
    <div className="dashboard-container">
      ...
      <div className="table-container">
        ...
        <div className="table-header">
          ...
          <div className="col-1 text-left">Followers Gained</div>
          <div className="col-1 text-left">Followers</div>
          <div className="col-1 text-left">Follower Growth Rate</div>
          <div className="col-1 text-left">Videos</div>
        ...
        {getPaginatedData().map((row, index) => (
          <div key={index} className="table-row">
            ...
            <div className="col-1 text-left">
              {row["Follower Growth Rate"] || "0%"}
            </div>

            {/* Videos */}
            <div className="col-1 text-left">{row["Videos"] || "0"}</div>
