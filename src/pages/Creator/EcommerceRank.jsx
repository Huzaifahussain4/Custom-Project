  ...
  const fetchData = async () => {
    try {
      ...
      const response = await fetch(
        "http://127.0.0.1:8000/api/Creator_Ecommerce_Rank/"
      );
    ...
    <div className="dashboard-container">
      ...
      <div className="table-container">
        ...
        <div className="table-header">
          ...
          <div className="col-2 text-left">Total Followers</div>
          <div className="col-1 text-left">Promoted Products</div>
