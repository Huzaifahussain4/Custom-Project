  ...
  const fetchData = async () => {
    try {
      ...
      const response = await fetch(
        "http://127.0.0.1:8000/api/Shop_Most_Promoted/"
      );
    ...
    <div className="dashboard-container">
      ...
      <div className="table-container">
        ...
        <div className="table-header">
          ...
          <div className="col-1 text-left">Products On Sell</div>
          <div className="col-1 text-left">Units Sold</div>
          <div className="col-1 text-left">Growth Rate</div>
        ...
        {getPaginatedData().map((row, index) => (
          <div key={index} className="table-row">
            ...
            {/* Growth Rate */}
            <div className="col-1 text-left">{row["Growth Rate"] || "0%"}</div>
